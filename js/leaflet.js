...
const Mesto = [
  ...
  { name: "Přechod", y: 2016, x: 2458, url: "/mista/varka/prechod.html", popis:"Město na severu Varky ležící na řece Gorce, blízké hranicím se Sardotem" },
  { name: "Ječín", y: 2120, x: 2822, url: "/mista/varka/jecin.html", popis:"Ječín (Jetschin) je poslední lidská výspa před vstupem do temného a prastarého Chvozdu. Odsud pocházejí ti nejlepší hraničáři, lovci a druidi z celé Varky." },
  { name: "Garagor", y: 1796, x: 2616, url: "/mista/varka/garagor.html", popis:"Garagor, obří hlavní město obehnané silnou vysokou zdí je domovem mnoha cechů, soudů a šlechtických sídel." },
  { name: "Ghetto", y: 1720, x: 2760, url: "/mista/varka/ghetto.html", popis:"Garagorské ghetto je velké místo, kde se koncentrují rasy všeho druhu - od trpaslíků a hobitů přes půlorky a tieflingy až po občasné drakorozené a drowy." },
  { name: "Limris", y: 1540, x: 1442, url: "/mista/varka/limris.html", popis:"Nezávislé město vedle Garagoru, jeden z přívozů na řece Gorce" },
  { name: "Morgstadt", y: 1554, x: 1658, url: "/mista/varka/morgstadt.html", popis:"První a největší nezávislé město Varky" },
  { name: "Okraj", y: 1288, x: 922, url: "/mista/varka/okraj.html", popis:"Nezávislé město na západním kraji Varky" },
  { name: "Durnhelm", y: 1336, x: 3096, url: "/mista/varka/durnhelm.html", popis:"Město na východě Varky, chudé ale vítající" },
