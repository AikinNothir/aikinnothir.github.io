function magnify(imgID, zoom) {
  ...
  const rect = img.getBoundingClientRect(); // jen jednou!
  ...
  function moveMagnifier(e) {
    ...
    mouseX = e.pageX - rect.left - window.pageXOffset;
    mouseY = e.pageY - rect.top - window.pageYOffset;
...
function magnify(imgID, zoom) {
  ...
  console.log(img.width + " " + img.height + " " + zoom )
  bw = 3;
